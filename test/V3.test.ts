  ...
  it.skip('should success deposit hsui to NAVI protocol', async () => {
    ...
    it.skip("query ReserveParentId", async () => {
      ...
      const rawData: any = await account.client.getDynamicFields({
        parentId: '0x287399b936f75e810e460f3d70ddb21d804d2224f16d04e9f3be12fe80115175',
    ...
    it.skip("query oracle", async () => {
      ...
      const rawData: any = await account.client.getDynamicFields({
        parentId: '0x05537e42f0b1e5f79167103fae36addc5d48d250d253aa98a1988595702eb5e1',
  ...
  const name = type.split("::").pop() || "Unknown"; 
        return {
          ...
          borrowBalanceParentId:
            data.content.fields.value.fields.borrow_balance.fields.user_state.fields.id.id,
          supplyBalanceParentId:
            data.content.fields.value.fields.supply_balance.fields.user_state.fields.id.id,
        };
      }
      let res = []
      const arr = [
